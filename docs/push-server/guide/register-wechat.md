...
访问[企业微信官网](https://work.weixin.qq.com/)进行注册。个人用户也可以免费注册，无需企业认证。按页面提示完成注册流程，并使用微信扫描二维码绑定管理员。
...
2. 系统会发送一条确认消息到您的企业微信 App，需在点击 **“发送”** 。
...
> [!IMPORTANT] 注意
> 还需要配置“网页授权及JS-SDK”的可信域名，则需要进行域名归属权校验。点击“申请校验域名”，下载校验文件并上传至您网站的根目录，确保可以通过公网访问该文件，然后点击确定即可。
